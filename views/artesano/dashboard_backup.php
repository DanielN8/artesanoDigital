...
// Debug temporal - Mostrar datos que están llegando
if (isset($_GET['debug'])) {
    echo "<div style='background: #f0f0f0; padding: 10px; margin: 10px; border: 1px solid #ccc;'>";
    echo "<h3>Debug - Datos del Dashboard:</h3>";
    echo "<p><strong>Usuario ID:</strong> " . ($usuario['id_usuario'] ?? 'No definido') . "</p>";
    echo "<p><strong>Usuario Nombre:</strong> " . ($usuario['nombre'] ?? 'No definido') . "</p>";
    echo "<p><strong>Tiene Tienda:</strong> " . ($tieneTienda ? 'Sí' : 'No') . "</p>";
    echo "<p><strong>Estadísticas:</strong> " . print_r($estadisticas ?? [], true) . "</p>";
    echo "<p><strong>Pedidos Recientes:</strong> " . count($pedidos_recientes ?? []) . " pedidos</p>";
    echo "<p><strong>Pedidos Personales:</strong> " . count($pedidos_personales ?? []) . " pedidos</p>";
    echo "<p><strong>Productos:</strong> " . count($productos ?? []) . " productos</p>";
    echo "</div>";
}
?>

<!-- CSS Modular para Dashboard -->
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
<link rel="stylesheet" href="/artesanoDigital/assets/css/dashboard-artesano.css">
<link rel="stylesheet" href="/artesanoDigital/assets/css/modales.css">
<link rel="stylesheet" href="/artesanoDigital/assets/css/modal-pedidos.css">
<link rel="stylesheet" href="/artesanoDigital/assets/css/modal-productos.css">
            ...
            <div class="dashboard-main">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-actions">
                            <button id="marcarTodasLeidas" class="btn btn-sm btn-outline-primary">
                                <i class="fas fa-check-double"></i> Marcar todas como leídas
                            </button>
                            <button id="limpiarNotificaciones" class="btn btn-sm btn-outline-warning" onclick="limpiarNotificacionesAntiguas(30)">
                                <i class="fas fa-broom"></i> Limpiar antiguas (30d)
                            </button>
                            <select id="filtroNotificaciones" class="form-control form-control-sm">
                                ...
                                <option value="estado_actualizado">Estados actualizados</option>
                                <option value="stock_bajo">Stock bajo</option>
                                <option value="pedido_confirmado">Pedidos confirmados</option>
                            </select>
                        </div>
                    </div>
                    <div class="card-body">
...
<div id="modalDetallePedido" class="modal">
    <div class="modal-content modal-large">
        ...
        <div class="modal-header">
            <h2>Gestión de Pedido <span id="pedidoNumero">#00000</span></h2>
            <div class="estado-actual">
                <span class="badge" id="estadoActualBadge">Pendiente</span>
            </div>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="pedido-tabs">
                <button class="modal-tab-btn active" data-modal-tab="resumen">Resumen</button>
                <button class="modal-tab-btn" data-modal-tab="seguimiento">Seguimiento</button>
            </div>
            
            <!-- Contenido de pestañas del modal -->
            <div class="modal-tab-content">
                <!-- TAB: Resumen Completo del Pedido -->
                <div class="modal-tab-pane active" id="modal-resumen">
                    <div class="pedido-resumen-completo">
                        ...
                        <div class="pedido-resumen-grid">
                            <div class="resumen-card">
                                ...
                                <div class="info-grid">
                                    ...
                                    <span class="value" id="fechaPedido">-</span>
                                    ...
                                    <div class="value">
                                        ...
                                        <button id="btnActualizarEstado" class="btn btn-sm btn-primary">Actualizar</button>
                                    </div>
                                    
                                    <span class="label">Método de Pago:</span>
                                    <span class="value" id="metodoPago">-</span>
                                    
                                    <span class="label">Total del Pedido:</span>
                                    <span class="value pedido-total" id="totalPedido">B/. 0.00</span>
                                </div>
                            </div>
                            ...
                            <div class="resumen-card">
                                ...
                                <div class="info-grid">
                                    ...
                                    <span class="value" id="subtotalPedido">B/. 0.00</span>
                                    
                                    <span class="label">Costo de Envío:</span>
                                    <span class="value" id="costoEnvio">B/. 0.00</span>
                                    
                                    <span class="label">Descuentos:</span>
                                    <span class="value" id="descuentosPedido">B/. 0.00</span>
                                    
                                    <span class="label total-row">Total Final:</span>
                                    <span class="value total-row" id="totalFinal">B/. 0.00</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cliente-seccion">
                            ...
                            <div class="cliente-datos">
                                <div class="dato-cliente">
                                    ...
                                    <span class="value" id="clienteNombre">-</span>
                                </div>
                                <div class="dato-cliente">
                                    <span class="label">Email:</span>
                                    <span class="value" id="clienteEmail">-</span>
                                </div>
                                <div class="dato-cliente">
                                    <span class="label">Teléfono:</span>
                                    <span class="value" id="clienteTelefono">-</span>
                                </div>
                                <div class="dato-cliente">
                                    <span class="label">Dirección de Entrega:</span>
                                    <span class="value" id="direccionEntrega">-</span>
                                </div>
                            </div>
                        </div>
                ...
                <!-- TAB: Seguimiento -->
                <div class="modal-tab-pane" id="modal-seguimiento">
                    <div class="seguimiento-container">
                        <div class="timeline-header">
                            <h4>Línea de Tiempo del Pedido</h4>
                        ...
                        <div id="formAgregarEvento" class="agregar-evento-form" style="display:none;">
                            <div class="form-group">
                                <label>Tipo de Evento:</label>
                                <select id="tipoEvento" class="form-select">
                                    <option value="estado_cambio">Cambio de Estado</option>
                                    <option value="envio">Información de Envío</option>
                                    <option value="comunicacion">Comunicación con Cliente</option>
                                    <option value="problema">Problema/Incidencia</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="descripcionEvento" class="form-textarea" rows="3" placeholder="Describe qué pasó en este momento..."></textarea>
                            </div>
                            
                            <div class="form-actions">
                                <button id="btnCancelarEvento" class="btn btn-secondary">Cancelar</button>
                                <button id="btnGuardarEvento" class="btn btn-primary">Guardar Evento</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-footer">
            <div class="footer-actions">
                ...
                <button class="btn btn-success" id="btnMarcarCompleto">Marcar como Completado</button>
                <button class="btn btn-warning" id="btnEnviarNotificacion">Notificar Cliente</button>
            </div>
        </div>
    </div>
</div>
...
<div id="modalDetalleProducto" class="modal">
    <div class="modal-content modal-large">
        <span class="close">&times;</span>
        <div class="modal-header">
            <h2>Detalles del Producto <span id="productoNombre">Producto</span></h2>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="producto-tabs">
                ...
                <button class="tab-btn" data-tab="precios">Precios y Stock</button>
                <button class="tab-btn" data-tab="imagenes">Imágenes</button>
            </div>
            ...
            <div class="tab-content">
                    ...
                    <div class="details-card">
                        <div class="detail-row">
                            ...
                            <div class="detail-content">
                                ...
                                <span id="productoNombreDetalle" class="detail-value">-</span>
                            </div>
                        </div>
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-content">
                                ...
                                <div id="productoDescripcionDetalle" class="detail-value detail-text">-</div>
                            </div>
                        </div>
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-content">
                                <span class="detail-label">ID de Producto</span>
                                <span id="productoIdDetalle" class="detail-value">-</span>
                            </div>
                        </div>
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-content">
                                ...
                                <span id="productoFechaCreacionDetalle" class="detail-value">-</span>
                            </div>
                        </div>
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-content">
                                ...
                                <span id="productoActivoDetalle" class="detail-value estado-badge">-</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="price-details">
                                <div class="price-item">
                                    ...
                                    <div>
                                        ...
                                        <span id="productoPrecioDetalle" class="price-value">B/. 0.00</span>
                                    </div>
                                </div>
                                
                                <div class="price-item discount-item" id="discountItem">
                                    <div class="price-icon">
                                        <i data-lucide="percent"></i>
                                    </div>
                                    <div>
                                        <span class="price-label">Descuento</span>
                                        <span id="productoDescuentoDetalle" class="discount-value">B/. 0.00</span>
                                    </div>
                                </div>
                                ...
                                <div class="price-item final-price">
                                    ...
                                    <div>
                                        ...
                                        <span id="productoPrecioFinalDetalle" class="final-price-value">B/. 0.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stock-details">
                                <div class="stock-item">
                                    ...
                                    <div>
                                        ...
                                        <span id="productoStockDetalle" class="stock-value">0 unidades</span>
                                    </div>
                                </div>
                                ...
                                <div class="stock-status-item">
                                    ...
                                    <div>
                                        ...
                                        <span id="productoStockStatusDetalle" class="stock-status-badge">-</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-pane" id="tab-imagenes">
                    <div class="image-section">
                        ...
                        <div class="image-container">
                            <img id="imagenPreview" src="" alt="Imagen del producto" class="product-image">
                            <div class="no-image-state" id="noImagePlaceholder">
                ...
                <div class="tab-pane" id="tab-seo">
                    <form id="formProductoSEO">
                        <div class="seo-section">
                            <h4>Optimización para Búsquedas</h4>
                            <div class="form-group">
                                <label for="productoSlug">URL del Producto</label>
                                <div class="url-preview">
                                    <span class="base-url">artesanodigital.com/productos/</span>
                                    <input type="text" id="productoSlug" class="form-input inline">
                                </div>
                                <div class="form-help">URL amigable para el producto</div>
                            </div>
                            
                            <div class="form-group">
                                <label for="productoMetaTitulo">Meta Título</label>
                                <input type="text" id="productoMetaTitulo" class="form-input" maxlength="60">
                                <div class="char-counter"><span id="metaTituloCounter">0</span>/60 caracteres</div>
                            </div>
                            
                            <div class="form-group">
                                <label for="productoMetaDescripcion">Meta Descripción</label>
                                <textarea id="productoMetaDescripcion" class="form-textarea" rows="3" maxlength="160"></textarea>
                                <div class="char-counter"><span id="metaDescripcionCounter">0</span>/160 caracteres</div>
                            </div>
                            
                            <div class="form-group">
                                <label for="productoTags">Tags/Etiquetas</label>
                                <input type="text" id="productoTags" class="form-input" placeholder="artesanía, panamá, hecho a mano">
                                <div class="form-help">Separar tags con comas</div>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="estadisticas-grid">
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                ...
                                <div class="stat-number" id="productoVisualizaciones">0</div>
                                <div class="stat-change">+0% este mes</div>
                            </div>
                        </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                <h4>Ventas</h4>
                                <div class="stat-number" id="productoVentas">0</div>
                                <div class="stat-change">+0% este mes</div>
                            </div>
                        </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                <h4>Favoritos</h4>
                                <div class="stat-number" id="productoFavoritos">0</div>
                                <div class="stat-change">+0% este mes</div>
                            </div>
                        </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                <h4>Calificación</h4>
                                <div class="stat-number" id="productoCalificacion">0.0</div>
                                <div class="stat-change">0 reseñas</div>
                            </div>
                        </div>
                    </div>
                    
                    <div class="ventas-chart">
                        <h4>Ventas en el Tiempo</h4>
                        <div class="chart-placeholder">
                            <p>Gráfico de ventas se mostrará aquí</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-footer">
            <div class="footer-actions">
                <button type="button" class="btn btn-secondary" id="btnCerrarProductoModal">Cerrar</button>
            </div>
        </div>
    </div>
</div>
...
<!-- CSS modularizado en archivos externos -->
        display: flex;
        gap: 2rem;
    ...
    /* ===== ESTILOS PARA MODAL DE GESTIÓN DE PEDIDOS ===== */
    .modal-large {
        max-width: 1200px;
        width: 95%;
        max-height: 95vh;
    ...
    .timeline-item.estado_cambio::before { background: #059669; }
    .timeline-item.envio::before { background: #f59e0b; }
    .timeline-item.comunicacion::before { background: #8b5cf6; }
    .timeline-item.problema::before { background: #ef4444; }
    .timeline-item.nota::before { background: #6b7280; }
    ...
    .status-en_camino { background: #fed7aa; color: #9a3412; }
    ...
    /* ===== MINIMALIST PRODUCTS DESIGN ===== */
    .productos-section-minimalist {
        max-width: 1200px;
        margin: 0 auto;
        padding: 2rem;
        background: transparent;
...
<style>
    ...
    /* Mini imagen en lista de productos */
    ...
    .precio-info-card, .stock-info-card {
        background: #f9fafb;
        border-radius: 10px;
        padding: 20px;
    }
    
    .precio-info-card h4, .stock-info-card h4 {
        margin-top: 0;
        margin-bottom: 15px;
        color: #4b5563;
        font-size: 1.1rem;
...
document.addEventListener('DOMContentLoaded', function() {
    // Manejar botones de eliminar producto
    const botonesEliminar = document.querySelectorAll('.btn-eliminar-producto');
    botonesEliminar.forEach(boton => {
        boton.addEventListener('click', function(e) {
            e.preventDefault();
            const idProducto = this.getAttribute('data-id');
            const nombreProducto = this.closest('.producto-card').querySelector('h4').textContent;
            ...
            if (confirm(`¿Estás seguro de que quieres eliminar el producto "${nombreProducto}"? Esta acción no se puede deshacer.`)) {
                ...
                form.method = 'POST';
                form.action = '/artesanoDigital/artesano/productos/eliminar';
    ...
    // Manejar botones de editar producto (para implementación futura)
    ...
    // Referencias al modal de productos
    const modalProducto = document.getElementById('modalDetalleProducto');
    const btnCerrarProductoModal = document.getElementById('btnCerrarProductoModal');
...
<!-- JavaScript Modular para Dashboard -->
<script src="/artesanoDigital/assets/js/dashboard-tabs.js"></script>
<script src="/artesanoDigital/assets/js/modal-pedidos.js"></script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if (isset($_SESSION['toast_mensaje'])): ?>
        ...
        if (typeof window.Toast !== 'undefined') {
            ...
            console.log('Toast: <?php echo addslashes($_SESSION['toast_mensaje']); ?>');
        }
        <?php
        // Limpiar los mensajes de la sesión después de usarlos
        unset($_SESSION['toast_mensaje']);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Manejar los botones de "Ver detalles"
    document.addEventListener('click', function(e) {
    ...
    function duplicarProducto(id) {
        if (confirm('¿Estás seguro de que quieres duplicar este producto?')) {
            ...
            console.log('Duplicar producto:', id);
        }
    }
    ...
    function configurarTabsModal() {
        ...
        modalTabBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                // Remover activo de todos los botones del modal
                modalTabBtns.forEach(b => b.classList.remove('active'));
                // Agregar activo al botón clickeado
                this.classList.add('active');
                
                // Ocultar todo el contenido del modal
    ...
    // Verificar pago (placeholder)
    function verificarPago(productoId) {
        alert('Funcionalidad de verificación de pagos en desarrollo');
    }

    // Configurar tabs del modal al abrir
    configurarTabsModal();

    // Cancelar edición
    document.getElementById('btnCancelarEdicion').addEventListener('click', function() {
        // Volver al tab de detalles
        tabBtns.forEach(b => b.classList.remove('active'));
        tabContents.forEach(content => content.classList.remove('active'));
        
        tabBtns[0].classList.add('active'); // Primer tab (detalles)
